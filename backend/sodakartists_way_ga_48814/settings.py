"""
Django settings for sodakartists_way_ga_48814 project.
...
ROOT_URLCONF = 'sodakartists_way_ga_48814.urls'
...
WSGI_APPLICATION = 'sodakartists_way_ga_48814.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "SodakArtists Way Gallery Support <support@sodakartists-way-ga-48814.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sodakartists_way_ga_48814 API",
    "DESCRIPTION": "API documentation for sodakartists_way_ga_48814 App",
    "VERSION": "v1",
}
